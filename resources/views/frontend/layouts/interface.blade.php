		...
		<header class="header-one header-two">
			...
			<div class="container text-center">
				<div class="row">
					<div class="col-sm-2">
						<div class="logo">
							<a href="index.html"><img src="{{asset('frontend/img')}}/logo2.png" alt="Sellshop" /></a>
						</div>
					</div>
					<div class="col-sm-8">
								...
								<nav>
									<ul>
										...
										<li><a href="shop.html">Shop</a>
											<ul class="magamenu">
												<li class="banner"><a href="shop.html"><img src="{{asset('frontend/img')}}/maga1.png" alt="" /></a></li>
												<li><h5>men’s wear</h5>
													<ul>
												...
												<li class="banner"><a href="shop.html"><img src="{{asset('frontend/img')}}/maga2.png" alt="" /></a></li>
											</ul>
										</li>
										<li><a href="#">Pages</a>
											<ul class="dropdown">
						...
						<div class="cart-itmes">
							...
							<div class="cartdrop">
								<div class="sin-itme clearfix">
									...
									<a class="cart-img" href="cart.html"><img src="{{asset('frontend/img')}}/cart/1.png" alt="" /></a>
								...
								<div class="sin-itme clearfix">
									<i class="mdi mdi-close"></i>
									<a class="cart-img" href="cart.html"><img src="{{asset('frontend/img')}}/cart/2.png" alt="" /></a>
									<div class="menu-cart-text">
										<a href="#"><h5>men’s black t-shirt</h5></a>
										<span>Color :  Black</span>
										<span>Size :     SL</span>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="single-colect banner collect-one">
							<a href="#"><img src="{{asset('frontend/img')}}/collect/4.jpg" alt="" /></a>
						</div>
					</div>
					<div class="col-sm-4">
						...
						<div class="collect-img banner margin single-colect">
							<a href="#"><img src="{{asset('frontend/img')}}/collect/5.jpg" alt="" /></a>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="collect-img banner single-colect">
							<a href="#"><img src="{{asset('frontend/img')}}/collect/6.jpg" alt="" /></a>
						</div>
						<div class="colect-text ">
						...
						<li>
							<div class="row text-center">
								<div class="col-xs-12 col-sm-6 col-md-3">
									<div class="single-product">
										<div class="product-img">
											...
											<a href="#"><img src="{{asset('frontend/img')}}/products/16.jpg" alt="Product Title" /></a>
								...
								<div class="col-xs-12 col-sm-6 col-md-3">
									<div class="single-product">
										<div class="product-img">
											...
											<a href="#"><img src="{{asset('frontend/img')}}/products/17.jpg" alt="Product Title" /></a>
											<div class="actions-btn">
												<a href="#"><i class="mdi mdi-cart"></i></a>
												<a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
												<a href="#"><i class="mdi mdi-heart"></i></a>
								...
								<div class="col-xs-12 col-sm-6 col-md-3 r-margin-top">
									<div class="single-product">
										<div class="product-img">
											...
											<a href="#"><img src="{{asset('frontend/img')}}/products/18.jpg" alt="Product Title" /></a>
											<div class="actions-btn">
												<a href="#"><i class="mdi mdi-cart"></i></a>
												<a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
												<a href="#"><i class="mdi mdi-heart"></i></a>
								...
								<div class="col-xs-12 col-sm-6 col-md-3 r-margin-top">
									<div class="single-product">
										<div class="product-img">
											<a href="#"><img src="{{asset('frontend/img')}}/products/19.jpg" alt="Product Title" /></a>
											<div class="actions-btn">
												<a href="#"><i class="mdi mdi-cart"></i></a>
												<a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
												<a href="#"><i class="mdi mdi-heart"></i></a>
						...
						<li>
							<div class="row text-center">
								<div class="col-xs-12 col-sm-6 col-md-3">
									<div class="single-product">
										<div class="product-img">
											...
											<a href="#"><img src="{{asset('frontend/img')}}/products/20.jpg" alt="Product Title" /></a>
											<div class="actions-btn">
												<a href="#"><i class="mdi mdi-cart"></i></a>
												<a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
												<a href="#"><i class="mdi mdi-heart"></i></a>
								...
								<div class="col-xs-12 col-sm-6 col-md-3">
									<div class="single-product">
										<div class="product-img">
											<a href="#"><img src="{{asset('frontend/img')}}/products/21.jpg" alt="Product Title" /></a>
											<div class="actions-btn">
												<a href="#"><i class="mdi mdi-cart"></i></a>
												<a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
												<a href="#"><i class="mdi mdi-heart"></i></a>
								...
								<div class="col-xs-12 col-sm-6 col-md-3 r-margin-top">
									<div class="single-product">
										<div class="product-img">
											...
											<a href="#"><img src="{{asset('frontend/img')}}/products/22.jpg" alt="Product Title" /></a>
											<div class="actions-btn">
												<a href="#"><i class="mdi mdi-cart"></i></a>
												<a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
												<a href="#"><i class="mdi mdi-heart"></i></a>
								...
								<div class="col-xs-12 col-sm-6 col-md-3 r-margin-top">
									<div class="single-product">
										<div class="product-img">
											<a href="#"><img src="{{asset('frontend/img')}}/products/23.jpg" alt="Product Title" /></a>
											<div class="actions-btn">
												<a href="#"><i class="mdi mdi-cart"></i></a>
												<a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
												<a href="#"><i class="mdi mdi-heart"></i></a>
				...
				<div class="row">
					<div class="col-sm-4 col-md-2">
						<div class="tab-menu nav nav-tabs padding">
							<ul>
								<li class="active"><a href="#dress1" data-toggle="tab" data-target="#dress1, #text1"><img src="{{asset('frontend/img')}}/coming/s1.jpg" alt="" /></a></li>
								<li><a href="#dress2" data-toggle="tab" data-target="#dress2,#text2"><img src="{{asset('frontend/img')}}/coming/s2.jpg" alt="" /></a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-7 col-md-5">
						<div class="text-center large-img tab-content">
							<div class="tab-pane fade in active" id="dress1">
								<img src="{{asset('frontend/img')}}/coming/l1.jpg" alt="" />
							...
							<div class="tab-pane fade" id="dress2">
								<img src="{{asset('frontend/img')}}/coming/l2.jpg" alt="" />
								<div class="count-text clearfix">
									<ul id="countdown-2">
										<li>
											<p class="timeRefDays timedescription">days</p>
								...
								<li>
									<div class="row text-center">
										...
										<div class="col-xs-12 col-sm-6 col-md-3">
											<div class="single-product">
												<div class="product-img">
													<a href="#"><img src="{{asset('frontend/img')}}/products/13.jpg" alt="Product Title" /></a>
													<div class="actions-btn">
														<a href="#"><i class="mdi mdi-cart"></i></a>
														<a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
														<a href="#"><i class="mdi mdi-heart"></i></a>
					...
					<ul class="load-list load-list-blog">
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="l-blog-text">
										<div class="banner"><a href="single-blog.html"><img src="{{asset('frontend/img')}}/blog/1.jpg" alt="" /></a></div>
								...
								<div class="col-sm-4">
									<div class="l-blog-text">
										<div class="banner"><a href="single-blog.html"><img src="{{asset('frontend/img')}}/blog/2.jpg" alt="" /></a></div>
										<div class="s-blog-text">
								...
								<div class="col-sm-4">
									<div class="l-blog-text">
										<div class="banner"><a href="single-blog.html"><img src="{{asset('frontend/img')}}/blog/3.jpg" alt="" /></a></div>
										<div class="s-blog-text">
						...
						<li>
							<div class="row">
								<div class="col-sm-4">
									<div class="l-blog-text">
										<div class="banner"><a href="single-blog.html"><img src="{{asset('frontend/img')}}/blog/4.jpg" alt="" /></a></div>
										<div class="s-blog-text">
											<h4><a href="single-blog.html">women’s winter Fashion style</a></h4>
											<span>By : <a href="#">Rakib</a> | <a href="#">210 Like</a> | <a href="#">69 Comments</a></span>
											<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour....</p>
								...
								<div class="col-sm-4">
									<div class="l-blog-text">
										<div class="banner"><a href="single-blog.html"><img src="{{asset('frontend/img')}}/blog/5.jpg" alt="" /></a></div>
										<div class="s-blog-text">
											<h4><a href="single-blog.html">Fashion style fine arts drawing</a></h4>
											<span>By : <a href="#">Rakib</a> | <a href="#">210 Like</a> | <a href="#">69 Comments</a></span>
											<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour....</p>
								...
								<div class="col-sm-4">
									<div class="l-blog-text">
										<div class="banner"><a href="single-blog.html"><img src="{{asset('frontend/img')}}/blog/6.jpg" alt="" /></a></div>
										<div class="s-blog-text">
											<h4><a href="single-blog.html">women’s Fashion style 2016</a></h4>
											<span>By : <a href="#">Rakib</a> | <a href="#">210 Like</a> | <a href="#">69 Comments</a></span>
											<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour....</p>
												...
												<div class="quick-image">
														...
														<div class="list-img">
															<div class="product-img tab-content">
																<div class="simpleLens-container tab-pane fade in" id="sin-1">
																	...
																	<a class="simpleLens-image" data-lens-image="{{asset('frontend/img')}}/products/z1.jpg" href="#"><img src="{{asset('frontend/img')}}/products/z1.jpg" alt="" class="simpleLens-big-image"></a>
																</div>
																<div class="simpleLens-container tab-pane active fade in" id="sin-2">
																	<div class="pro-type sell">
																		<span>sell</span>
																	</div>
																	<a class="simpleLens-image" data-lens-image="{{asset('frontend/img')}}/products/z2.jpg" href="#"><img src="{{asset('frontend/img')}}/products/z2.jpg" alt="" class="simpleLens-big-image"></a>
																</div>
																<div class="simpleLens-container tab-pane fade in" id="sin-3">
																	<div class="pro-type">
																		<span>-15%</span>
																	</div>
																	<a class="simpleLens-image" data-lens-image="{{asset('frontend/img')}}/products/z3.jpg" href="#"><img src="{{asset('frontend/img')}}/products/z3.jpg" alt="" class="simpleLens-big-image"></a>
																</div>
																<div class="simpleLens-container tab-pane fade in" id="sin-4">
																	<div class="pro-type">
																		<span>new</span>
																	</div>
																	<a class="simpleLens-image" data-lens-image="{{asset('frontend/img')}}/products/z4.jpg" href="#"><img src="{{asset('frontend/img')}}/products/z4.jpg" alt="" class="simpleLens-big-image"></a>
																</div>
															</div>
														</div>
													</div>
													<div class="quick-thumb">
														<ul class="product-slider">
															<li><a data-toggle="tab" href="#sin-1"> <img src="{{asset('frontend/img')}}/products/s1.jpg" alt="quick view" /> </a></li>
															<li class="active"><a data-toggle="tab" href="#sin-2"> <img src="{{asset('frontend/img')}}/products/s2.jpg" alt="small image" /> </a></li>
															<li><a data-toggle="tab" href="#sin-3"> <img src="{{asset('frontend/img')}}/products/s3.jpg" alt="small image" /> </a></li>
															<li><a data-toggle="tab" href="#sin-4"> <img src="{{asset('frontend/img')}}/products/s4.jpg" alt="small image" /> </a></li>
														</ul>
													</div>
												</div>						
											</div>
							...
							<div class="col-xs-12 col-sm-6 col-md-3 r-margin-top wide-mobile">
								<div class="single-text">
									...
									<div class="clearfix instagram">
										<ul>
											<li><a href="#"><img src="{{asset('frontend/img')}}/footer/in1.png" alt="Instagram" /></a></li>
											<li><a href="#"><img src="{{asset('frontend/img')}}/footer/in2.png" alt="Instagram" /></a></li>
											<li><a href="#"><img src="{{asset('frontend/img')}}/footer/in3.png" alt="Instagram" /></a></li>
											<li><a href="#"><img src="{{asset('frontend/img')}}/footer/in4.png" alt="Instagram" /></a></li>
											<li><a href="#"><img src="{{asset('frontend/img')}}/footer/in5.png" alt="Instagram" /></a></li>
											<li><a href="#"><img src="{{asset('frontend/img')}}/footer/in6.png" alt="Instagram" /></a></li>
										</ul>
									</div>
								</div>
							</div>
